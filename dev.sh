...
test() {
    ...
    if command -v sbt &> /dev/null; then
        ...
        docker run --rm -v "$(pwd)":/app -w /app sbtscala/scala-sbt:1.11.0-openjdk-21 sbt test
    fi
...
format() {
    ...
    if command -v sbt &> /dev/null; then
        ...
        docker run --rm -v "$(pwd)":/app -w /app sbtscala/scala-sbt:1.11.0-openjdk-21 sbt scalafmtAll
    fi
...
ci() {
    ...
    if command -v sbt &> /dev/null; then
        ...
        docker run --rm -v "$(pwd)":/app -w /app sbtscala/scala-sbt:1.11.0-openjdk-21 sbt compile
    fi
