...
if %errorlevel% neq 0 (
    ...
    docker run --rm -v "%cd%":/app -w /app sbtscala/scala-sbt:1.8.2-openjdk-21 sbt test
) else (
...
if %errorlevel% neq 0 (
    ...
    docker run --rm -v "%cd%":/app -w /app sbtscala/scala-sbt:1.8.2-openjdk-21 sbt scalafmtAll
) else (
...
sbt compile >nul 2>&1
if %errorlevel% neq 0 (
    docker run --rm -v "%cd%":/app -w /app sbtscala/scala-sbt:1.8.2-openjdk-21 sbt compile
) else (
    sbt compile
)
