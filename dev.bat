...
if %errorlevel% neq 0 (
    ...
    docker run --rm -v "%cd%":/app -w /app sbtscala/scala-sbt:openjdk-21.0.2_1.9.7_3.4.3 sbt test
) else (
...
if %errorlevel% neq 0 (
    ...
    docker run --rm -v "%cd%":/app -w /app sbtscala/scala-sbt:openjdk-21.0.2_1.9.7_3.4.3 sbt scalafmtAll
) else (
...
sbt compile >nul 2>&1
if %errorlevel% neq 0 (
    docker run --rm -v "%cd%":/app -w /app sbtscala/scala-sbt:openjdk-21.0.2_1.9.7_3.4.3 sbt compile
) else (
    sbt compile
)
